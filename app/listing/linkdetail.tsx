...
import Bookmark from "../(tabs)/Historys";
...
const ListingDetails = () => {
  const { idphong } = useLocalSearchParams();
  ...
  const bookphong = async ()=>{
    const a = await axios.post('https://66dbfa2047d749b72aca6935.mockapi.io/webappsale/user/'+idphong,{
      history:{
        idphong:id,
        macode:String(Math.floor(Math.random() * 99999) + 10000)
      }
    })
  }
